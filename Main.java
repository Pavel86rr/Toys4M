...
public class Main {
    public static void main(String[] args) {
        ...
        //сам розыгрыш
        //Вывод бросков для наглядности расчета или сокрытие можно сделать, раскомментировав или закоментировав 44-ю строчку в Raffle
        ...
        toys1.saveToFile("src/src/toyListSkl.txt");
    }
